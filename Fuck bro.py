...
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mANTO

\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801972239643

\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1I don't have a YouTube channel
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("https://www.facebook.com/ANTO.THE.GAME.CHANGER")
...
def crack2(idf,pwv):
	...
	print('\r%s [ANTO🥰] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				...
				if 'ya' in oprek:
					...
					print('\r%s [ANTO-CP💔] %s|%s        '%(b,idf,pw))
